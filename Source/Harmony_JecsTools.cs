...
namespace LightSabers
{
    ...
    internal static class Harmony_JecsTools
    {
        ...
        private static bool loadedJedi;
        private static bool loadedJec;
        ...
        static Harmony_JecsTools()
        {
            ...
            if (!modCheck)
            {
                ...
                {
                    if (loadedJedi && loadedJec) break; //Save some loading
            ...
            if (loadedJec)
            {
                try
                {
                    harmony.Patch(
                              ...
                              new HarmonyMethod(typeof(Harmony_JecsTools), nameof(DrawEquipmentAimingPreFix)),
                              new HarmonyMethod(typeof(Harmony_JecsTools), nameof(DrawEquipmentAimingPostFix)));
                    ...
                    if (loadedJedi)
                    {
                        harmony.Patch(
                                    ...
                                    null,
                                    new HarmonyMethod(typeof(Harmony_JecsTools), nameof(DrawEquipment_PostFix)));
                    }
                }
